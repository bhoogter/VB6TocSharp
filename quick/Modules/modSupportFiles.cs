...
static class modSupportFiles
{
    ...
    public static string CreateProjectFile(string vbpFile)
    {
        ...
        foreach (var iterL in new List<string>(Split(VBPClasses(vbpFile) + vbCrLf + VBPModules(vbpFile), vbCrLf)))
        {
            L = iterL;
            if (L == "") goto SkipClass;
    ...
    public static string AppXamlCsFile()
    {
        ...
        R = R + N + "";
        _AppXamlCsFile = R;
        return _AppXamlCsFile;
    }
    public static string SettingsSettingsFile()
    {
        string _SettingsSettingsFile = "";
        string R = "";
        string M = "";
        string N = "";
        R = ""; M = ""; N = vbCrLf;
        ...
        R = R + N + "  <Settings />";
        R = R + N + "</SettingsFile>";
        _SettingsSettingsFile = R;
        return _SettingsSettingsFile;
    }
    public static string SettingsDesignerCsFile()
    {
        string _SettingsDesignerCsFile = "";
        string R = "";
        string M = "";
        string N = "";
        R = ""; M = ""; N = vbCrLf;
        ...
        R = R + N + "    }";
        R = R + N + "}";
        _SettingsDesignerCsFile = R;
        return _SettingsDesignerCsFile;
    }
    public static string AssemblyInfoFile()
    {
        string _AssemblyInfoFile = "";
        string R = "";
        string M = "";
        string N = "";
        R = ""; M = ""; N = vbCrLf;
        ...
        _AssemblyInfoFile = R;
        return _AssemblyInfoFile;
    }
    public static string ResourcesResxFile()
    {
        string _ResourcesResxFile = "";
        string R = "";
        string M = "";
        string N = "";
        R = ""; M = ""; N = vbCrLf;
        ...
        _ResourcesResxFile = R;
        return _ResourcesResxFile;
    }
    public static string ResourcesDesignerCsFile()
    {
        string _ResourcesDesignerCsFile = "";
        string R = "";
        string M = "";
        string N = "";
        R = ""; M = ""; N = vbCrLf;
        ...
        R = R + N + "    }";
        R = R + N + "}";
        _ResourcesDesignerCsFile = R;
        return _ResourcesDesignerCsFile;
    }
