...
'  S = S & N
  ...
  S = S & N & ""
  S = S & N & "    public static DateTime CDate(object A) { return IsDate(A.ToString()) ? DateTime.MinValue : System.DateTime.Parse(A.ToString()); }"
  ...
  S = S & N & "    public static string Chr(long C) { return Chr((int)C); }"
  S = S & N & "    public static string Mid(string S, long F) { return Mid(S, (int)F); }"
  S = S & N & "    public static string Mid(string S, long F, long L) { return Mid(S, (int)F, (int)L); }"
  S = S & N & "    public static string Left(string S, long F) { return Left(S, (int)F); }"
  S = S & N & "    public static string Right(string S, long F) { return Right(S, (int)F); }"
  ...
  S = S & N & "    public static bool setToolTipText(this Control c, string Id) { return true; }"
  S = S & N & ""
  ...
  S = S & N & "    public static bool Show(this Window w, long Modal) { w.ShowDialog(); return true; }"
  S = S & N & "    public static bool setHelpContextID(this Window w, long Id) { return true; }"
  ...
  S = S & N & "    public static List<Control> Controls(this Window w) { return new List<Control>(); }"
  ...
  S = S & N & ""
  S = S & N & ""
  S = S & N & "    public static double TextWidth(this Canvas t, string s) { return s.Length * 10; }"
  S = S & N & "    public static double TextHeight(this Canvas t, string s) { return 10; }"
  S = S & N & "    public static long itemData(this ComboBox c, int I) { try { return ((long)((ComboboxItem)c.Items[I]).Value); } catch (Exception e) { return 0; } }"
  S = S & N & "    public static long itemData(this ListBox c, int I) { try { return ((long)((ComboboxItem)c.Items[I]).Value); } catch (Exception e) { return 0; } }"
  S = S & N & ""
  S = S & N & ""
  S = S & N & "    public class ComboboxItem"
  S = S & N & "    {"
  S = S & N & "        public ComboboxItem(string vText) { Text = vText; }"
  S = S & N & "        public ComboboxItem(string vText, object vValue) { Text = vText; Value = vValue; }"
  S = S & N & "        public string Text { get; set; }"
  S = S & N & "        public object Value { get; set; }"
